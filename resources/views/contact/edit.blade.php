...
@section('custom-js')
{!! JsValidator::formRequest('App\Http\Requests\contact\UpdateRequest', '#contact-form'); !!}
<script>
$('#contact-form').on('submit', function (e) {
    ...
    $.ajax({
        url: "{{route('api.contact.update',$contact)}}",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
<?php 
    ...
    $count  = ($custom_field && count($custom_field)>0)?count($custom_field):0; 
?>
var count = {{ $count }}
